        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-14">
          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center">
              <img src="/lets-travelz-logo-new.png" alt="Let's Travelz" className="h-24 w-auto object-contain" />
            </Link>
            ...
            <div className="flex gap-4">
              {[
                ...
                { name: 'LinkedIn', url: 'https://www.linkedin.com/', icon: 'M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-2.8v8.37h2.8v-4.67c0-.25.02-.5.1-.68a1.14 1.14 0 0 1 1-.77c.76 0 1 .56 1 1.39v4.73h2.8M6.5 8.37a1.37 1.37 0 0 0 1.3-1.41a1.37 1.37 0 0 0-1.3-1.41a1.37 1.37 0 0 0-1.3 1.41a1.37 1.37 0 0 0 1.3 1.41M8 18.5V10.13H5.2V18.5H8' }
              ].map((social) => (
