...
const StatCard = ({ label, value, unit = "" }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-[2.5rem] border border-neutral-100 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 text-center group flex flex-col justify-center items-center gap-2 aspect-square w-full">
      <div className="text-4xl lg:text-5xl font-black text-brand-dark group-hover:text-brand-gold transition-colors flex justify-center items-baseline gap-1">
        <span ref={countRef}>0</span>
        <span className="text-brand-gold text-2xl lg:text-3xl">{unit}</span>
      </div>
      <div className="text-[10px] uppercase tracking-[0.25em] font-black text-neutral-400 group-hover:text-brand-dark transition-colors mt-2 leading-relaxed max-w-[150px]">
        {label}
      </div>
    </div>
  );
...
const About = () => {
  ...
  return (
    <div ref={containerRef} className="pt-20">
      {/* Hero */}
      <Hero
        heroImage="https://images.unsplash.com/photo-1488646953014-85cb44e25828?auto=format&fit=crop&q=80&w=2000"
        heroTitle="Your Journey Starts"
        heroSubtitle="with Let’s Travelz!!"
        heroBadge="About Us"
      />
      ...
      <section className="py-32 container mx-auto px-6 bg-brand-dark rounded-[4rem] text-white overflow-hidden relative">
        <div className="relative z-10">
          <div className="gsap-reveal mb-20 text-center max-w-3xl mx-auto">
            ...
            <p className="text-neutral-400 mt-6 text-lg font-medium">
      ...
      <section className="py-40 text-center container mx-auto px-6">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="gsap-reveal flex flex-col sm:flex-row gap-8 justify-center items-center">
            <Link to="/contact" className="bg-brand-gold text-white px-12 py-5 rounded-full font-black text-xl hover:scale-110 hover:shadow-2xl hover:shadow-brand-gold/40 transition-all">
              Book Your Stay Now
            </Link>
