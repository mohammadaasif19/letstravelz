    ...
    <div ref={containerRef} className="pt-20">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center bg-brand-dark overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center flex flex-col items-center">
          ...
          <h2 className="text-6xl md:text-[10rem] font-black text-white tracking-tighter leading-[0.85] gsap-reveal drop-shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
            Explore <br />
            <span className="gold-gradient italic">United Kingdom</span>
          </h2>
          <p className="gsap-reveal text-white/80 text-lg md:text-xl font-medium mt-10 max-w-2xl mx-auto leading-relaxed drop-shadow-lg">
            Your gateway to the historic charm and modern prestige of Britain.
          </p>
        </div>
      </section>
      ...
      <section className="relative py-48 overflow-hidden bg-brand-dark">
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1529655683826-aba9b3e77383?auto=format&fit=crop&q=80&w=2000" className="w-full h-full object-cover opacity-60" alt="Tower Bridge, London" />
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <div className="gsap-reveal max-w-4xl mx-auto space-y-10">
            <h2 className="text-4xl md:text-7xl font-black text-white leading-tight tracking-tighter">Plan an Unforgettable Experience in <span className="text-brand-gold">UK Today!</span></h2>
